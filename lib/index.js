  ...
  _onAcquire(id, opts) {
    ...
    return new Promise(resolve => {
      ...
      result => {
        ...
        // ignore module with paths mapped to remote fetch.
        // for example { paths: { 'vs': 'https://cdnjs.cloudflare.com/ajax/libs/monaco-editor/0.20.0/min/vs' }}
        if (parsedId.bareId.match(/^(?:https?:)?\/\//)) return true;
